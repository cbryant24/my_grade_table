 ...
 * @function
 * @param {string} fb_id user requested id for sql query
 * @returns {string} raw sql query for assignment record creation, used in modal confirmation
 */
 ...
 * @function
 * @param {string} fb_id user requested id for sql query
 * @returns {string} raw sql query for grades record creation, used in modal confirmation
 */
